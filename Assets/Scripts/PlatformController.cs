...
[RequireComponent(typeof(ActivateOnTouch))]
public class PlatformController : RaycastController {
    ...
    Dictionary<Transform, Controller2DPlayer> passengerDictionary = new Dictionary<Transform, Controller2DPlayer>();
    ...
    void MovePassengers(bool beforeMovePlatform){
        foreach(PassengerMovement passenger in passengerMovement) {
            if (!passengerDictionary.ContainsKey(passenger.transform)) {
                passengerDictionary.Add(passenger.transform, passenger.transform.GetComponent<Controller2DPlayer>());
            }
    ...
    public void ResetThis(){
        ...
        newPos = origPos;
        globalWaypoints = resetWaypoints;
        origWaypoints = globalWaypoints;
        SetupWaypoints();
